DESCRIPTION = "Node offering the HW services for controlling the Crawlee #1 platform."
SECTION = "devel"
LICENSE = "GPLv3"
...
SRC_URI = "file:///home/christoph/ros_catkin_ws/src/ros_edison_${PV}.tar.gz;downloadfilename=ros_edison_{PV}.tar.gz"
